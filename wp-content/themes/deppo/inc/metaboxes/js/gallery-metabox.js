  ...
  $(document).on('click', '#gallery-metabox a.gallery-add', function(e) {
    ...
    file_frame.on('select', function() {
      ...
      selection.map(function(attachment, i) {
        ...
        $('#gallery-metabox-list').append('<li><input type="hidden" name="vdw_gallery_id[' + index + ']" value="' + attachment.id + '"><img class="image-preview" src="' + attachment.sizes.thumbnail.url + '"><a class="change-image button button-small" href="#" data-uploader-title="Change image" data-uploader-button-text="Change image">Change image</a><small><a class="remove-image" href="#"></a></small></li>');
      });
    });
